...
var build = {
    ...
    "registerNewService": function (dbConfiguration, serviceObj, collection, cb) {
        ...
        return registerNewService(dbConfiguration, serviceObj, collection, cb);
    },
...
exports.loadByEnv = function (param, cb) {
    ...
    if (registry) {
        return loadRegistryByEnv({"envCode": param.envCode, "dbConfig": registry.coreDB.provision}, cb);
    }
    else
...
exports.loadOtherEnvControllerHosts = function (cb) {
    var registry = loadProfile(regEnvironment);
    if (registry) {
        return loadOtherEnvHosts({"envCode": regEnvironment, "dbConfig": registry.coreDB.provision}, cb);
    }
    else
        return cb(new Error("unable to find provision config information to connect to!"));
};
